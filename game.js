...
function addHero(){
	...
	var sphereMaterial = new THREE.MeshStandardMaterial( { color: 0xffe666 ,shading:THREE.FlatShading, roughness:1, emissive:0xff0000} )
	jumping=false;
...
function addWorld(){
	...
	var sphereMaterial = new THREE.MeshStandardMaterial( { color: 0xafefef ,shading:THREE.FlatShading , roughness:1} )
